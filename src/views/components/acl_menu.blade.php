@if(Auth()->user()->isAbleTo([Config::get('lara-core.permissions.menu.main')]))
    <li class="treeview {{ isActive( ['roles-assignment.index', 'roles.index', 'permissions.index'], 'is-expanded' ) }}">
        ...
        <ul class="treeview-menu">
            @if(Auth()->user()->isAbleTo([Config::get('lara-core.permissions.menu.users')]))
                <li>
            ...
            @endif
            @if(Auth()->user()->isAbleTo([Config::get('lara-core.permissions.menu.roles')]))
                <li>
            ...
            @endif
            @if(Auth()->user()->isAbleTo([Config::get('lara-core.permissions.menu.permissions')]))
                <li>
